...
function isNewerAlphaVersionAvailable(context, availableVersion) {
    ...
    const isAlphaAvailable = !!((_a = semver.prerelease(availableVersion)) === null || _a === void 0 ? void 0 : _a.includes("alpha"));
    const isSameWithAlphaAvailable = !!currentVersion && semver.eq(((_b = semver.coerce(availableVersion)) === null || _b === void 0 ? void 0 : _b.version) || "", currentVersion) && isAlphaAvailable;
