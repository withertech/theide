...
function handleDownloadingInProgress() {
    ...
    const progressInterval = setInterval(() => {
        void requests_1.getState().then((state) => {
            if ((state === null || state === void 0 ? void 0 : state.download_state.status) === state_1.DownloadStatus.FINISHED || (state === null || state === void 0 ? void 0 : state.download_state.last_failure)) {
                statusBar_1.setDefaultStatus();
...
function downloadPercentage(download_state) {
    ...
    return (download_state === null || download_state === void 0 ? void 0 : download_state.kind) === state_1.DownloadProgress.DOWNLOADING
        ? Math.round(100 *
            (toMB(download_state.crnt_bytes || 0) / toMB(download_state.total_bytes || 1))).toString()
        : "100";
}
function toMB(x) {
